<x-layouts.admin-layout title="Añadir Nuevo Usuario">
    <div class="admin-panel-card">
        <form action="/admin/usuarios" method="POST" class="admin-form">
            @csrf
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="admin-form-field" placeholder="Nombre" required>
                </div>
                <div class="admin-form-group">
                    <label for="apellido" class="admin-form-label">Apellido</label>
                    <input type="text" id="apellido" name="apellido" value="{{ old('apellido') }}" class="admin-form-field" placeholder="Apellido" required>
                </div>
            </div>
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" class="admin-form-field" placeholder="ejemplo@correo.com" required>
                </div>
                <div class="admin-form-group">
                    <label for="password" class="admin-form-label">Contraseña</label>
                    <input type="password" id="password" name="password" class="admin-form-field" placeholder="Mínimo 6 caracteres" required>
                </div>
            </div>
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="text" id="telefono" name="telefono" value="{{ old('telefono') }}" class="admin-form-field" placeholder="Ej. 1133445566">
                </div>
                <div class="admin-form-group">
                    <label for="direccion" class="admin-form-label">Dirección (Opcional)</label>
                    <input type="text" id="direccion" name="direccion" value="{{ old('direccion') }}" class="admin-form-field" placeholder="Calle, Número, Piso/Dpto">
                </div>
            </div>
            ...
            <div class="admin-form-actions">
                ...
                <button type="submit" class="admin-btn admin-btn-primary">Guardar Usuario</button>
            </div>
        </form>
    </div>
