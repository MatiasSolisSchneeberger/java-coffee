<x-admin-layout title="Añadir Nuevo Producto">
    <div class="admin-panel-card">
        <form action="/admin/productos" method="POST" class="admin-form"
            onsubmit="event.preventDefault(); alert('Simulación: Formulario de creación de producto enviado correctamente.'); window.location.href='/admin/productos';">
            @csrf
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="number" id="stock" name="stock" class="admin-form-field" placeholder="10"
                        required>
                </div>
                <div class="admin-form-group">
                    <label for="imagen" class="admin-form-label">Imagen de Portada (Simulación)</label>
                    <input type="file" id="imagen" name="imagen" class="admin-form-field"
            ...
            <div class="admin-form-group">
                <label for="descripcion_larga" class="admin-form-label">Descripción Larga / Detalles del
                    Producto</label>
                <textarea id="descripcion_larga" name="descripcion_larga" class="admin-form-field admin-form-textarea"
                    placeholder="Información detallada, origen, perfil de sabor, notas de cata o características técnicas..."
